...
export default function Feedback() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (result.length === 0) {
          setError(
            "No feedback found for this interview. Please complete the interview first."
          );
        }
      } catch (error) {
  ...
  const getPerformanceData = () => {
    const excellent = feedbackList.filter(
      (item) => Number(item.rating) >= 4
    ).length;
    const good = feedbackList.filter(
      (item) => Number(item.rating) >= 3 && Number(item.rating) < 4
    ).length;
    const needsWork = feedbackList.filter(
      ...
      return {
        ...
        message: (
          <div className="dark:text-gray-300">
            &quot; Don&apos;t worry! Every expert was once a beginner. Focus on
            providing more detailed answers with specific examples.&quot; ,
          </div>
        ),
      };
            ...
            <CardContent className="p-8">
              <div className="grid md:grid-cols-4 gap-6">
                <div className="md:col-span-1 text-center">
                  ...
                  <h2 className={`text-2xl font-bold ${remarkData.color} mb-2`}>
                    {remarkData.title}
                  </h2>
                      ...
                      <div className="w-full bg-muted rounded-full h-2 mt-2">
                        <div
                          ...
                          style={{
                            width: `${
                              feedbackList.length > 0
                                ? (excellent / feedbackList.length) * 100
                                : 0
                            }%`,
                          }}
                        ></div>
                      ...
                      <div className="w-full bg-muted rounded-full h-2 mt-2">
                        <div
                          ...
                          style={{
                            width: `${
                              feedbackList.length > 0
                                ? (needsWork / feedbackList.length) * 100
                                : 0
                            }%`,
                          }}
                        ></div>
                    ...
                    <div className="border-t border-gray-100">
                      ...
                      >
                        <TabsList>
                          ...
                          <TabsTrigger value="your-answer">
                            Your Answer
                          </TabsTrigger>
                          <TabsTrigger value="ideal-answer">
                            Ideal Answer
                          </TabsTrigger>
