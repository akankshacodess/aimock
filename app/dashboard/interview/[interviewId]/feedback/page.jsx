    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <Card className={`border-0 shadow-xl ${remarkData.bgColor} ${remarkData.borderColor} border-2 dark:bg-card dark:border-border`}>
                  ...
                  <div className="flex items-center justify-center gap-1 mb-2">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-5 h-5 ${
                          i < Math.round(Number(averageRating)) ? "text-yellow-400 fill-yellow-400" : "text-gray-300 dark:text-gray-600"
                        }`}
                      />
                    ))}
                  </div>
                  <div className="text-3xl font-bold text-foreground">{averageRating}/5.0</div>
                </div>

                <div className="md:col-span-3 space-y-6">
                  <p className="text-lg leading-relaxed text-foreground">{remarkData.message}</p>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-card/80 rounded-lg p-4 text-center border border-border">
                      <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">{good}</div>
                      <div className="text-sm text-muted-foreground">Good (3-4)</div>
                      <div className="w-full bg-muted rounded-full h-2 mt-2">
                        <div
                    ...
                    <div className="bg-card/80 rounded-lg p-4 text-center border border-border">
                      <div className="text-2xl font-bold text-red-600 dark:text-red-400">{needsWork}</div>
                      <div className="text-sm text-muted-foreground">Needs Work (1-3)</div>
                      <div className="w-full bg-muted rounded-full h-2 mt-2">
                        <div
