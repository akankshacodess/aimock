...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen w-full box-border bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors duration-500" style={{overflowX: "hidden"}}>
      {/* Header Section */}
      <header className="w-full bg-white/80 dark:bg-gray-900/90 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800 sticky top-0 z-40 shadow-sm" style={{overflowX: "hidden"}}>
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6" style={{boxSizing: "border-box"}}>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 min-w-0 flex-wrap w-full">
            <motion.div
